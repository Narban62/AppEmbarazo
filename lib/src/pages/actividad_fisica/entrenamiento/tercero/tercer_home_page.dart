...
class TercerHomePage extends StatefulWidget {
  const TercerHomePage({super.key});

  @override
  State<TercerHomePage> createState() => _TercerHomePageState();
}

class _TercerHomePageState extends State<TercerHomePage> {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            const ImagenWidget(
                imagesrc: 'assets/images/actividad_fisica/tercer_trimestre/img_1.png',
                isPrincipal: false),
            Padding(
              padding: const EdgeInsets.all(16.0),
              child: Row(
